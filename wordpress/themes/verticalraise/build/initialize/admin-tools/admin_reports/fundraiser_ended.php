...
use \classes\app\admin_reports\Fundraiser_Ended_Reports;

/**
 * Page to see Reports of Fundraiser_ended
 */

?>

<h2>Fundraisers Ended</h2>
...
<form id="submitForm" method="post" action="/wp-admin/admin.php?page=fundraisers_ended">
...
<?php if (isset($_POST)) { 
    ...
    $fundraiser_ended = new Fundraiser_Ended_Reports();
