...
use \classes\app\admin_reports\Fundraisers;
...
<form id="submitForm" method="post" action="/wp-admin/admin.php?page=fundraisers">
...
<?php if (isset($_POST)) {
    ...
    $result      = $fundraisers->get_all_fundraisers();
