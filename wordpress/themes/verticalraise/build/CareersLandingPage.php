    ...
    <body <?php body_class(); ?>>
        ...
        <div class="wrapper">
            ...
            <main>
                ...
                <?php get_template_part( 'template-parts/marketing/careers_opportunities' ); ?>

                <?php get_template_part( 'template-parts/marketing/careers_blackbox' ); ?>

                <?php get_template_part( 'template-parts/marketing/gradient_form' ); ?>

            </main>

            <?php get_template_part( 'template-parts/marketing/careers_modal' ); ?>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $(".career_opportunities").click(function(){
                    $('html, body').animate(
                        { scrollTop: $("#career_opportunities").offset().top -100}
                        , 800);
                });

                $("#resume_upload_btn").click(function(){
                    $("#resume-modal-upload").modal("show");
                });
                ...
                $("#get_more_info").click(function (e) {
                    e.preventDefault();
                    $('html, body').animate({
                        scrollTop: $(".hero_content").offset().top
                    }, 1000);
                })
