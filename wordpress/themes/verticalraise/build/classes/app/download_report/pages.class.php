...
use \classes\app\download_report\Participant_Data;
use \classes\app\download_report\Admin_Data;
...
class Pages
{
    ...
    public function __construct($f_id) {
        ...
        $this->participant_data = new Participant_Data();
        $this->admin_data       = new Admin_Data();
