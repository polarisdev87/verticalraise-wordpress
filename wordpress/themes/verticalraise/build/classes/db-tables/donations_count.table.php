...
$ct_class[basename(__FILE__)] = 'Donations_Count_Table';

// Load the parent class
load_class('db_custom_tables.class.php');

class Donations_Count_Table extends DB_Custom_Tables
{
    
    /**
     * @var string $table_name The name of the table
     */
    protected $table_name = "donations_count";
    ...
    /**
     * Run the Wordpress custom table setup. The table 'donations_count' will be added to the database if it does not already exist.
     * @return void
     */
    public function run() {
