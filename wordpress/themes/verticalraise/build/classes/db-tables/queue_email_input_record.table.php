...
class Email_Queue_Table extends DB_Custom_Tables
{
     ...
     */
    protected $table_name = "email_queue_table";
    ...
    /**
     * Run the Wordpress custom table setup. The table 'email_queue_table' will be added to the database if it does not already exist.
     * @return void
     */
    public function run() {
