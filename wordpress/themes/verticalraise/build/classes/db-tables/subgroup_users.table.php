...
$ct_class[basename(__FILE__)] = 'Subgroup_Users_Table';
// Load the parent class
load_class('db_custom_tables.class.php');
class Subgroup_Users_Table extends DB_Custom_Tables
{
    
    /**
     * @var string $table_name The name of the table
     */
    protected $table_name = "subgroup_users";
    ...
    /**
     * Run the Wordpress custom table setup. The table 'subgroup_users' will be added to the database if it does not already exist.
     * @return void
     */
    public function run() {
    ...
    private function sql($table_name, $charset_collate) {
        ...
        $sql = "CREATE TABLE {$table_name} (
          subgroup_id mediumint(11) NOT NULL,
          u_id mediumint(11) NOT NULL,
          PRIMARY KEY  (subgroup_id, u_id),
          index subgroup_id_u_id_idx (subgroup_id, u_id)
