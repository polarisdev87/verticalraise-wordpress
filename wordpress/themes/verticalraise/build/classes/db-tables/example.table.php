...
$ct_class[basename(__FILE__)] = 'Example_Table';

// Load the parent class
load_class('db_custom_tables.class.php');

class Example_Table extends DB_Custom_Tables
{
    ...
    /**
     * Run the Wordpress custom table setup. The table 'example' will be added to the database if it does not already exist.
     * @return void
     */
    public function run() {
