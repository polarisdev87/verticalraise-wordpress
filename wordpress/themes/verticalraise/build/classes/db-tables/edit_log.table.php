...
$ct_class[basename(__FILE__)] = 'Edit_Log_Table';

// Load the parent class
load_class('db_custom_tables.class.php');

class Edit_Log_Table extends DB_Custom_Tables
{
    
    /**
     * @var string $table_name The name of the table
     */
    protected $table_name = "edit_log";
    ...
    /**
     * Run the Wordpress custom table setup. The table 'edit_log' will be added to the database if it does not already exist.
     * @return void
     */
    public function run() {
