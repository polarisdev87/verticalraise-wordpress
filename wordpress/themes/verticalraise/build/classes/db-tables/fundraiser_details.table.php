...
$ct_class[basename(__FILE__)] = 'Fundraiser_Details_Table';

// Load the parent class
load_class('db_custom_tables.class.php');

class Fundraiser_Details_Table extends DB_Custom_Tables
{

    /**
     * @var string $table_name The name of the table
     */
    protected $table_name = "fundraiser_details";
    ...
    private function sql( $table_name, $charset_collate ) {
        ...
        $sql = "CREATE TABLE {$table_name} (
		  ...
		  secondary_end_date TIMESTAMP NULL,
          goal DECIMAL(8,2) NOT NULL,
          transferred tinyint NULL,
          PRIMARY KEY  (id),
          UNIQUE KEY unique_key (f_id)
