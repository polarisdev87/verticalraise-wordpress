...
$ct_class[basename(__FILE__)] = 'Donation_Comments_Table';

// Load the parent class
load_class('db_custom_tables.class.php');

class Donation_Comments_Table extends DB_Custom_Tables
{
    
    /**
     * @var string $table_name The name of the table
     */
    protected $table_name = "donation_comments";
