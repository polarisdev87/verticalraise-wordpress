...
$ct_class[basename(__FILE__)] = 'Stripe_Transfers_Table';
// Load the parent class
load_class('db_custom_tables.class.php');
class Stripe_Transfers_Table extends DB_Custom_Tables
{
    
    /**
     * @var string $table_name The name of the table
     */
    protected $table_name = "stripe_transfers";
    ...
    /**
     * Run the Wordpress custom table setup. The table 'stripe_transfers' will be added to the database if it does not already exist.
     * @return void
     */
    public function run() {
