...
$ct_class[basename(__FILE__)] = 'Shorturls_table';

// Load the parent class
load_class('db_custom_tables.class.php');

class Shorturls_Table extends DB_Custom_Tables
{
    
    /**
     * @var string $table_name The name of the table
     */
    protected $table_name = "shorturls";
    ...
    /**
     * Run the Wordpress custom table setup. The table 'shorturls' will be added to the database if it does not already exist.
     * @return void
     */
    public function run() {
    ...
    private function sql($table_name, $charset_collate) {
        ...
        $sql = "CREATE TABLE {$table_name} (
          ...
          utm_medium varchar(30) NOT NULL,
          utm_campaign varchar(30) NOT NULL,
          utm_content varchar(30) NOT NULL,
          utm_term varchar(10) NOT NULL,
