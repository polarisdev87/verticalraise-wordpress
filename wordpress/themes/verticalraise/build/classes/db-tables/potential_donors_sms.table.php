...
$ct_class[basename(__FILE__)] = 'Potential_Donors_SMS_Table';

// Load the parent class
load_class('db_custom_tables.class.php');

class Potential_Donors_SMS_Table extends DB_Custom_Tables
{

    /**
     * @var string $table_name The name of the table
     */
    protected $table_name = "potential_donors_sms";
    ...
    /**
     * Run the Wordpress custom table setup. The table 'potential_donors_sms' will be added to the database if it does not already exist.
     * @return void
     */
    public function run() {
