...
$ct_class[basename(__FILE__)] = 'Potential_Donors_Email_Table';

// Load the parent class
load_class('db_custom_tables.class.php');

class Potential_Donors_Email_Table extends DB_Custom_Tables
{
    /**
     * @var string $table_name The name of the table
     */
    protected $table_name = "potential_donors_email";
    ...
    /**
     * Run the Wordpress custom table setup. The table 'fundraiser_sadmin' will be added to the database if it does not already exist.
     * @return void
     */
    public function run() {
    ...
    private function sql($table_name, $charset_collate) {
        ...
        $sql = "CREATE TABLE {$table_name} (
          ...
          p_donator varchar(255) NOT NULL,
