...
$ct_class[basename(__FILE__)] = 'Stripe_Connect_Ids_Table';

// Load the parent class
load_class('db_custom_tables.class.php');

class Stripe_Connect_Ids_Table extends DB_Custom_Tables
{
    
    /**
     * @var string $table_name The name of the table
     */
    protected $table_name = "stripe_connect_ids";
    ...
    private function sql($table_name, $charset_collate) {
        ...
        $sql = "CREATE TABLE {$table_name} (
          ...
          stripe_account_id varchar(99) NOT NULL,
          PRIMARY KEY  (id)
