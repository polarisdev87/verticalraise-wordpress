...
/* Template Name: Business Fundraising  */
...
<html <?php language_attributes(); ?>>
    ...
    <head>
        ...
        <meta name="description" content="Business fundraisers and Fundraising"/>
        <link rel="canonical" href="<?php the_permalink(); ?>" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Business Fundraising - Vertical Raise" />
        <meta property="og:description" content="Business fundraisers and Fundraising" />
        ...
        <meta name="twitter:description" content="Business fundraisers and Fundraising" />
        <meta name="twitter:title" content="Business Fundraising - Vertical Raise" />
        ...
        <script type='application/ld+json' class='yoast-schema-graph yoast-schema-graph--main'>{
                ...
                "@graph": [
                    ...
                    },
                    {
                        ...
                        "inLanguage": "en-US",
                        "name": "Business Fundraising - Vertical Raise",
                        "isPartOf": {
                            "@id": "https://verticalraise.com/#website"
                        },
                        "datePublished": "2019-05-29T22:24:08+00:00",
                        "dateModified": "2019-07-31T22:12:37+00:00",
                        "description": "Business fundraisers and Fundraising"
                    }
                ]
            }</script>
        <!-- SET: FONTS -->
    ...
    <body <?php body_class(); ?>>
        ...
        <div class="wrapper">
            ...
            <header class="<?php echo $header_class; ?>">
                ...
                <div class="container clearfix logo_container">
                    ...
                    <div class="logo <?php echo $logo_class ?>">
                            <img alt="<?php the_title_attribute(); ?>" class="band-fundraiser-logo" src="<?php echo get_template_directory_uri() . "/assets/images/logo.png" ?>" alt="">
                    </div>
                    <!--LOGO END-->
            ...
            <main>
                ...
                <?php get_template_part( 'template-parts/marketing/business/we_raise_section' ); ?>

                <?php get_template_part( 'template-parts/marketing/business/gradient_section' ); ?>

                <?php get_template_part( 'template-parts/marketing/business/real_fundraisers_section' ); ?>
