<?php
/* Template Name: Team Logo Upload */
...
if ( is_user_logged_in() ) {
    ...
    if ( isset( $_GET['return'] ) ) {
        switch ( $_GET['return'] ) {
            case 'editfundraiser' :
                $return_url = get_site_url() . '/single-fundraiser/?fundraiser_id=' . $_GET['f_id'] . '&editpopup=1#multimedia';
                break;
            case 'permalink':
    ...
    <html class="profile_upload_html" style="<?php if ( is_mobile() ) { ?>overflow:scroll !important;<?php } ?>">
        ...
        <body class="iframe_imageUpload">
            <div class="mobile_popup_fix" id="profile_image_upload">
                <input type="hidden" value="team_logo_image" id="upload_type" />
                ...
                <div id="loading" style="display: none; text-align: center;">
                    ...
                    <div class="progress" style="width:200px; margin:0 auto;height:inherit">
                        <div class="bar" style="width: 200px; background: white;">
                            <div id="progressBar"
                ...
                <div id="success-screen" style="display: none; text-align: center;">
                    ...
                    <input type="hidden" name="upload_url" id="uploadurl" value="" />
                    <br>
                    <br>
                    <h4>
                        The Team logo image was successfully uploaded!
                    </h4>
                    <br>
                    <br>
                    <?php if ( !is_mobile_new() ) { ?>
